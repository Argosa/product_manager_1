    ...
    const onSubmitHandler = (e) => {
        ...
        axios.post("http://localhost:8000/api/product/new", {
            ...
            .then(res => {
                ...
                alert("You have submitted a product");
            })
    ...
    return(
        <div>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <div>
                    <label>Price</label>
                    <input type="text" className="form-control" id="price" name="price" required onChange={onChangeHandler}/>
                </div>
                <div>
                    <label>Description</label>
                    <textarea className="form-control" id="description" name="description" onChange={onChangeHandler}/>
                </div>
